...
{
    /// <summary>
    /// Proxy property getters and setters onto a collection of dynamic extensions
    /// </summary>
    public class DynamicExtensionContainer : DynamicObject, ICustomTypeDescriptor
    {
        ...
        /// <summary>
        /// Add a dynamic extension that intercepts property gets and sets from this view model
        /// </summary>
        ...
        static PropertyDescriptorCollection GetDynamicPropertyDescriptors(DynamicExtensionContainer Container)
        {
            ...
            return new System.ComponentModel.PropertyDescriptorCollection(Result.ToArray());
        }
